...
**/
cowapi.peers = function(){
    return _(core.peers()).filter(function(d){return (!d.deleted());});
};
/**
    projects() - return non-deleted projects
**/
cowapi.projects = function(){
    return _(core.projects()).filter(function(d){return !d.deleted();});
};
/**
    users() - return all users that are not deleted
**/
cowapi.users = function(){
    return _(core.users()).filter(function(d){return !d.deleted();});
};
/**
    delpeers() - return only non-deleted (active) peers
**/
cowapi.delpeers = function(){
    return _(core.peers()).filter(function(d){return (d.deleted());});
};
/**
    features(permtype) - return non-deleted features with permission type permtype or that belong to user
**/
cowapi.features = function(permtype){
...
**/
cowapi.featureCollections = function(){
    return _(core.project().items()).filter(function(d){
...
**/
cowapi.messages = function(permtype){
    if (core.project()){
...
**/
cowapi.cur_proj_users = function(){
    //first get peers
...
**/
cowapi.msg = function(msgbox,item){
    ...
    */
    ...
    var names = cowapi.usernames();
    var tags = cowapi.tags();
...
/**
**/
cowapi.tracker = function(status){
    this.running = false;
    var self = this;
};
cowapi.tracker.prototype = {
